        ...
        <div class="section-body">
            ...
            <div class="card">
                <div class="card-header">
                    <h4><i class="fas fa-book-open"></i> Slide</h4>
                </div>
                            ...
                            <div class="input-group mb-3">
                                @can('sliders.create')
                                    <div class="input-group-prepend">
                                        <a href="{{ route('admin.slider.create') }}" class="btn btn-primary" style="padding-top: 10px;"><i class="fa fa-plus-circle"></i> TAMBAH</a>
                                    </div>
                                @endcan
