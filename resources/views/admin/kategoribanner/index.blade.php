            ...
            <div class="section-body">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4><i class="fas fa-tags"></i> Kategori Banner</h4>
                    </div>

                    <div class="card-body">
                        <form action="{{ route('admin.kategoribanner.index') }}" method="GET">
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    @can('katdatas.create')
                                        <div class="input-group-prepend">
                                            <a href="{{ route('admin.kategoribanner.create') }}" class="btn btn-primary" style="padding-top: 10px;"><i class="fa fa-plus-circle"></i> TAMBAH</a>
                                        </div>
                                    @endcan
                                    ...
                                    @foreach ($data as $no => $row)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('admin.kategoribanner.edit', $row->id) }}"
