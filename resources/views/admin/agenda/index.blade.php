                            ...
                            <div class="input-group mb-3">
                                @can('agendas.create')
                                    <div class="input-group-prepend">
                                        <a href="{{ route('admin.agenda.create') }}" class="btn btn-primary" style="padding-top: 10px;"><i class="fa fa-plus-circle"></i> TAMBAH</a>
                                    </div>
                                @endcan
                            ...
                            @foreach ($agendas as $no => $agen)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @can('agendas.delete')
                                            <button onClick="Delete(this.id)" class="btn btn-sm btn-danger" id="{{ $agen->id }}">
